...
const Blog = () => {
  return (
    <>
     <div>
          {/* Page Title Start */}
          <section className="page-title title-bg24">
            ...
            <div className="container">
              ...
              <div className="row">
                ...
                <div className="col-lg-4">
                  <div className="blog-widget blog-search">
                    <form>
                  ...
                  <div className="blog-widget blog-category">
                    <h3>Category</h3>
                    <ul>
                      <li>
                  ...
                  <div className="blog-widget blog-tags">
                    <h3>Tags</h3>
                    <ul>
                      <li>
                        <a href="link">Web Design</a>
